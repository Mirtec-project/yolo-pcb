...
test_images_folder = 'yolo_dataset/test/images'  # 실제 폴더 경로로 변경하세요

# 모델 추론 실행 (박스만 표시하도록 라벨 및 신뢰도 제거 옵션 추가)
results = model.predict(source=test_images_folder, conf=0.25, hide_labels=True, hide_conf=True, save=True)
